...
#+BEGIN_SRC emacs-lisp
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(undo-tree hydra amx yaml-mode twig-mode magit counsel-gtags php-mode flycheck-phpstan pocket-mode markdown-mode py-autopep8 elpy less-css-mode w32-browser transpose-frame sqlplus solarized-theme smart-mode-line php-eldoc packed helm-w3m helm-gtags grep-a-lot ggtags geben flycheck fill-column-indicator f epc emms dired+ counsel-projectile ace-window ac-helm)))
  (custom-set-faces
